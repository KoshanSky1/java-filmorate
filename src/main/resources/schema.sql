...
CREATE TABLE IF NOT EXISTS D01_DIRECTOR (
                                           D01_ID INTEGER    AUTO_INCREMENT NOT NULL PRIMARY KEY,
                                           D01_NAME VARCHAR(255) --NOT NULL
);

CREATE TABLE IF NOT EXISTS F05_FILM_DIRECTOR (
                                                F05_ID INTEGER   AUTO_INCREMENT NOT NULL PRIMARY KEY,
                                                F01_ID INTEGER NOT NULL,
                                                D01_ID INTEGER NOT NULL,
                                                FOREIGN KEY (F01_ID) REFERENCES F01_FILM(F01_ID),
                                                FOREIGN KEY (D01_ID) REFERENCES D01_DIRECTOR(D01_ID)
);
